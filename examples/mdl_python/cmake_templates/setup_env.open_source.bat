...
set @ENV_LIB_PATH@=@ENV_MDL_SDK_PATH_BAT@/@_CONFIG@;@ENV_FREEIMAGE_PATH_BAT@/@_CONFIG@;@ENV_OPENIMAGEIO_PATH_BAT@/@_CONFIG@;@ENV_DDS_PATH_BAT@/@_CONFIG@;@ENV_MDLDISTILLER_PATH_BAT@/@_CONFIG@;%@ENV_LIB_PATH@%
