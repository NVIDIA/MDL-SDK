...
@ENV_LIB_PATH@=@ENV_MDL_SDK_PATH@/@_CONFIG@:@ENV_FREEIMAGE_PATH@/@_CONFIG@:@ENV_OPENIMAGEIO_PATH@/@_CONFIG@:@ENV_DDS_PATH@/@_CONFIG@:@ENV_MDLDISTILLER_PATH@/@_CONFIG@${@ENV_LIB_PATH@:+:${@ENV_LIB_PATH@}}
export @ENV_LIB_PATH@
