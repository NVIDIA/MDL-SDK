...
// [NVIDIA modfication]
enum ImGuiWindowResizeHandle_
{
    ImGuiWindowResizeHandle_Top             = 0,
    ImGuiWindowResizeHandle_Right           = 1,
    ImGuiWindowResizeHandle_Bottom          = 2,
    ImGuiWindowResizeHandle_Left            = 3,
    ImGuiWindowResizeHandle_Corner          = 4,

    ImGuiWindowResizeHandle_COUNT
};
...
enum ImGuiColorEditFlags_
{
    ...
    ImGuiColorEditFlags_BigPreview      = 1 << 10 | ImGuiColorEditFlags_NoInputs, // ColorEdit, ColorPicker: disable inputs sliders/text widgets and show a wide preview colored bar).
    // END NVIDIA modifciations
