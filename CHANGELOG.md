...
ABI compatible with the MDL SDK 2025.0.0 (387700.1252) binary release
(see [https://developer.nvidia.com/mdl-sdk](https://developer.nvidia.com/mdl-sdk))
...
- MDL Compiler and Backends
    ...
    - Fixed core compiler not recognizing several declarative properties, causing missing errors
      ...
      with declarative structs defined in the `::df` module (`bsdf_components` and alikes).
...
- MDL Compiler and Backends
    - MDL Core: Due to an inconsistency in the MDL Specification the MDL compiler
    ...
    - libbsdf:
        - Fixed the handling of total internal reflection for microfacet BSDFs evaluation
