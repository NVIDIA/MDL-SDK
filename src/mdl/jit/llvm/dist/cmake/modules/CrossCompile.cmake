function(llvm_create_cross_target_internal target_name toolchain buildtype)
  ...
  # changed for MDL
  # allow to pass the flags from the cache
  set(_FLAG_LIST_${target_name} "")
  foreach(_FLAG ${CROSS_TOOLCHAIN_FLAGS_${target_name}})
    list(APPEND _FLAG_LIST_${target_name} ${_FLAG})
    message(STATUS "_FLAG: "  ${_FLAG})
  endforeach()

  # changed for MDL
  # allow run the cross build from non-top-level CMakeLists 
  if(NOT LLVM_CMAKE_SOURCE_DIR)
    set(LLVM_CMAKE_SOURCE_DIR ${CMAKE_SOURCE_DIR})
  endif()

  add_custom_command(OUTPUT ${LLVM_${target_name}_BUILD}/CMakeCache.txt
    COMMAND ${CMAKE_COMMAND} -G "${CMAKE_GENERATOR}"
        -DCMAKE_MAKE_PROGRAM="${CMAKE_MAKE_PROGRAM}"
        ${_FLAG_LIST_${target_name}} ${LLVM_CMAKE_SOURCE_DIR}
