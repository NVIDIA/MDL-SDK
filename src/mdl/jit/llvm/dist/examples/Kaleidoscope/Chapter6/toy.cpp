...
static MISTD::map<MISTD::string, Value*> NamedValues;
...
Value *UnaryExprAST::Codegen() {
  ...
  Function *F = TheModule->getFunction(MISTD::string("unary")+Opcode);
  if (F == 0)
...
Value *BinaryExprAST::Codegen() {
  ...
  // a call to it.
  Function *F = TheModule->getFunction(MISTD::string("binary")+Op);
