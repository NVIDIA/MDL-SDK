...
public:
  ...
  explicit BitVector(unsigned s, bool t = false) : Size(s) {
    ...
    Bits = (BitWord *)::malloc(Capacity * sizeof(BitWord));
  ...
  BitVector(const BitVector &RHS) : Size(RHS.size()) {
    ...
    Bits = (BitWord *)::malloc(Capacity * sizeof(BitWord));
    memcpy(Bits, RHS.Bits, Capacity * sizeof(BitWord));
  }
  ...
  const BitVector &operator=(const BitVector &RHS) {
    ...
    if (Size <= Capacity * BITWORD_SIZE) {
      if (Size)
        memcpy(Bits, RHS.Bits, RHSWords * sizeof(BitWord));
      clear_unused_bits();
      return *this;
    }
    ...
    Capacity = RHSWords;
    BitWord *NewBits = (BitWord *)::malloc(Capacity * sizeof(BitWord));
    memcpy(NewBits, RHS.Bits, Capacity * sizeof(BitWord));
