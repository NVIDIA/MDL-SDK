...
public:
  ...
  void getAllMetadata(SmallVectorImpl<MISTD::pair<unsigned, MDNode*> > &MDs)const{
    if (hasMetadata())
  ...
  void getAllMetadataOtherThanDebugLoc(SmallVectorImpl<MISTD::pair<unsigned,
                                       MDNode*> > &MDs) const {
...
private:
  ...
  void getAllMetadataImpl(SmallVectorImpl<MISTD::pair<unsigned,MDNode*> > &)const;
  void getAllMetadataOtherThanDebugLocImpl(SmallVectorImpl<MISTD::pair<unsigned,
                                           MDNode*> > &) const;
