...
private:
  ...
  // Mutex for access to the layout max.
  mutable sys::SmartMutex<true> LayoutLock;
...
public:
  ...
  /// deleteLayoutCache - Delete the struct layout cache entry.
  /// The next call to getStructLayout will create a new one.
  void deleteLayoutCache() const;
