...
void MachineBlockPlacement::buildCFGChains(MachineFunction &F) {
  ...
  DEBUG({
    // cannot use SmallPtrSet<MachineBasicBlock *, 16> here because the comma would be
    // interpreted inside the macro scope
    typedef BlockFilterSet FunctionBlockSetType;
